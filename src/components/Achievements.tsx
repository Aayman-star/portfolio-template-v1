  ...
  return (
    <Layout>
      <div
        ref={ref}
        id="Achievements"
        className="w-full h-auto md:min-h-screen p-4 md:p-0 md:px-[5rem] flex flex-col items-center gap-y-4 md:max-w-7xl md:mx-auto  md:flex-row md:items-center justify between">
        {/* div for the image */}
        <motion.div
          variants={variants}
          animate={controls}
